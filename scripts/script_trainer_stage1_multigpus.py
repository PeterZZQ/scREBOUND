...
def main():
    ...
    if model.module.model_config.dynamic_maskprob:
        model.module.mask_scheduler = trainer_batch.MaskScheduler(initial_prob = 0.15, final_prob = 0.4, total_steps = steps_per_epoch)
    ...
    with sdpa_kernel(SDPBackend.FLASH_ATTENTION):
        trainer_batch.train_multigpus(model = model, train_config = train_config, optimizer = optimizer, scheduler = scheduler, writer = writer)
