...
PRETRAIN_MODEL = PROJECT_DIR + "checkpoint/model_6_256_nobatch/" + model_name + ".pth"
...
model_config.__dict__.update({"batch_size": batch_size,
                              ...
                              "lamb_mincut": 1,
                              "mlm_type": "raw-restart",
                              "lamb_mlm": 10,
                              "sup_type": "contrcb",
                              "lamb_sup": 1,
                              "precision": PRECISION,
                              "checkpoint_path": PROJECT_DIR + "checkpoint/model_6_256_nobatch/",
                              "checkpoint_prefix": "cp_contrcb1_mlm10_dyn_" + model_name.removeprefix("cp_").removesuffix("_1"),
                              "lognorm_data": False
                            })
